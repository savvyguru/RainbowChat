...
public class AudioCallTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("i[class='fas fa-phone']")));
            WebElement phone = driver.findElement(By.cssSelector("i[class='fas fa-phone']"));
            phone.click();
            ////add another action for phone call(agent selection?)
